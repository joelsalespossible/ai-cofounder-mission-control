...
```json
{
  ...
  "payload": {
    "kind": "agentTurn",
    "message": "Run: python3 [WORKSPACE]/bridge_prune.py --days 7\nReport output.",
    "model": "[CHEAP_MODEL]",
    "timeoutSeconds": 60
  },
  "delivery": { "mode": "none" }
