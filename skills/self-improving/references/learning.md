...
**Good:** User explicitly states preference, pattern consistent across contexts, user confirms when asked.

**Bad:** Inferred from silence, contradicts recent behavior, only works in narrow context, user never confirmed.
